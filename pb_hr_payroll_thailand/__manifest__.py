# -*- coding: utf-8 -*-
{
    'name': 'Thailand Payroll Extension',
    'version': '16.0.1.0.0',
    'category': 'Human Resources/Payroll',
    'summary': 'Thailand Payroll Structure Extension for Odoo HR Payroll',
    'description': """
        This module extends the base payroll module to support Thailand payroll structure.
        It adds:
        - Thailand specific salary components
        ...
        - Enhanced Deductions: SSF, Income Tax, Provident Fund
    ...
    'data': [
        ...
        'wizards/social_security_wizard_views.xml',
        'views/contract_updater_views.xml',
        'views/report_payslip_thailand_template.xml',
        'views/hr_payroll_report_thailand.xml',
        'views/payslip_print_wizard_views.xml',
        # Translations
        'i18n/pb_hr_payroll_thailand.pot',
        'i18n/vi_VN.po',
        'i18n/km_KH.po',
    ],
    'installable': True,
