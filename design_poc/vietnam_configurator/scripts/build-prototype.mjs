...
for (const [key, file] of Object.entries({STYLE2:'option2.css', DATA:'data.js', ENGINE:'engine.js', CORE2:'option2-core.js', UI2:'option2-ui.js'})) option2 = option2.replace(`/*__${key}__*/`, () => readFileSync(`src/${file}`, 'utf8'));
