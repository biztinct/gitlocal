...
registry.category("pb_coach.tours").add("tour_formula", {
    ...
    steps: [
        ...
        },
        {
            ...
            body: "Switch to a spreadsheet Grid, run Test samples to validate every rule, or open Settings — all from here. Let's open the Grid.",
            action: "observe",
        },
        {
            selector: '[data-coach="fs-view-grid"]',
            waitFor: '[data-coach="fs-view-grid"]',
            title: "Open the Grid",
            body: "Click Grid to see every component laid out as spreadsheet columns — column letter, code, formula and its live value, all in one view.",
            action: "click",
        },
        {
            selector: '[data-coach="grid-canvas"]',
            waitFor: '[data-coach="grid-canvas"]',
            timeout: 5000,
            title: "The full spreadsheet grid",
            body: "Each component is a column; the rows show its Name, Category, Type, Formula, live Value and a Valid check. Walk it with the arrow keys — A, B, C… straight across.",
            action: "observe",
        },
        {
            selector: '[data-coach="grid-fbar"]',
            waitFor: '[data-coach="grid-fbar"]',
            timeout: 4000,
            title: "The formula bar",
            body: "Click any Formula cell and it loads here. Edit it in the bar or press F2 in the cell — the same validated round-trip either way, with live green/red feedback as you type.",
            action: "observe",
            placement: "bottom",
        },
        {
            selector: '[data-coach="grid-hint"]',
            waitFor: '[data-coach="grid-hint"]',
            timeout: 4000,
            title: "Edit, multi-select & drag-fill",
            body: "Enter saves, Esc cancels, Ctrl+Z undoes. Shift- or Ctrl-click column headers to select several and bulk-set their category in one go, or drag a formula's fill handle sideways to copy it with the cell references translated automatically. Editing is off in this shared demo — ask us for a private trial.",
            action: "observe",
        },
        {
