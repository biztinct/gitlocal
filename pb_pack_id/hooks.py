# -*- coding: utf-8 -*-
"""F113 — pb_pack_id install-time certification (D113.3).

Runs the Indonesia template's sample-test suite through the validated engine after
...
def post_init_hook(env):
    certify_pack_templates(env, ['pb_pack_id.tpl_id_standard_2026'])
