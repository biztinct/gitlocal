...
- **Live validation**: Chrome MCP against https://payobook.com (apex admin ash@biztinct.com/{withheld: apex-admin-2026-08},
...
- CR33 (P4): the apex admin password documented in this ledger (`ash@biztinct.com/{withheld: apex-admin-2026-08}`) is
