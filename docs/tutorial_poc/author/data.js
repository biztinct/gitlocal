...
const QA = [
...

  {
    ...
    blocks: [
      { k: "p", v: B("Whoever holds one of the three payroll groups these leaves are gated on — a payroll officer, a payroll manager or a super administrator. Note who is NOT on that list: a final approver signs for money and still does not get the wage roster, because approving a total and reading everybody's salary are different permissions. Everybody else does not see a greyed-out screen; they do not have the leaf in their sidebar at all.",
                     "Những ai giữ một trong ba nhóm quyền lương mà các mục này bị chặn theo — chuyên viên tính lương, quản lý lương hoặc quản trị viên cấp cao. Hãy để ý ai KHÔNG có trong danh sách đó: người phê duyệt cuối ký cho những khoản tiền mà vẫn không có danh sách lương, vì duyệt một con số tổng và đọc lương của từng người là hai quyền khác nhau. Người khác không thấy một màn hình bị làm mờ; họ không hề có mục đó trong thanh bên của mình.") },
